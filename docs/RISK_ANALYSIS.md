...
<!-- private-refs-notice -->
> **Referenced but not in this repository:** premium tests and workflows (`chaos.test.ts`, `appointments.booking.rate-limit.test.ts`); SUT-side files (`CONTRACT_PACK.md`). These live in the private repos — see *Premium content* in `README.md`.
