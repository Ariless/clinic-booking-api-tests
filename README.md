...
| | |
| --- | --- |
| **Suite** | 350 unique tests · 415 runs across projects · 80 test files |
| **Requirements** | 117 of 121 covered — `docs/RTM.md` |
| **Defect register** | **34 closed entries**, 1 open, 4 design debt — `docs/KNOWN_ISSUES.md` |
