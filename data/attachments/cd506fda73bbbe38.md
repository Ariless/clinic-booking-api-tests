...
- Name: api/contract.drift.test.js >> OpenAPI spec — contract drift guard @api >> All error codes are documented in the spec @api
- Location: tests/api/contract.drift.test.js:99:5

# Error details

```
Error: Error codes missing from OpenAPI spec: SLOT_TAKEN, INVALID_TRANSITION, APPOINTMENT_NOT_FOUND, SLOT_NOT_FOUND, UNKNOWN_SPECIALTY, CLAUDE_UNAVAILABLE, PAYMENT_REQUIRED, AUTH_REQUIRED, FORBIDDEN, VALIDATION_ERROR

expect(received).toHaveLength(expected)

Expected length: 0
Received length: 10
Received array:  ["SLOT_TAKEN", "INVALID_TRANSITION", "APPOINTMENT_NOT_FOUND", "SLOT_NOT_FOUND", "UNKNOWN_SPECIALTY", "CLAUDE_UNAVAILABLE", "PAYMENT_REQUIRED", "AUTH_REQUIRED", "FORBIDDEN", "VALIDATION_ERROR"]
```
