...
- Name: api/auth.delete.test.ts >> account soft delete @api >> DELETE /auth/me — 401 access token rejected on any endpoint after deletion @api @security
- Location: tests/api/auth.delete.test.ts:32:7
