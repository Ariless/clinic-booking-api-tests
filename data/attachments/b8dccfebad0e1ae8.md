...
- Name: api/appointments.type.test.ts >> POST /appointments — appointment type @api >> POST /appointments — 201 explicit type consultation @smoke @api
- Location: tests/api/appointments.type.test.ts:19:9
