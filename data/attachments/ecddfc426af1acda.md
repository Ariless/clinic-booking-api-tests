...
- Name: api/appointments.type.test.ts >> POST /appointments — appointment type @api >> POST /appointments — 201 type procedure, slot 60min @smoke @api
- Location: tests/api/appointments.type.test.ts:34:9
