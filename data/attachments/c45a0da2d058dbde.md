...
- Name: api/contract.drift.test.js >> OpenAPI spec — contract drift guard @api >> All expected schemas are defined in components @api
- Location: tests/api/contract.drift.test.js:108:5

# Error details

```
Error: Schemas missing from OpenAPI spec: WaitlistOffer, Consultation, Payment, ConsultationResponse

expect(received).toHaveLength(expected)

Expected length: 0
Received length: 4
Received array:  ["WaitlistOffer", "Consultation", "Payment", "ConsultationResponse"]
```
